/**
 * @file i_input_facade.hpp
 * @author Roël Couwenberg (contact@roelc.me)
 * @brief This file contains the IInputFacade interface definition.
 * @version 0.1
 * @date 2023-11-22
 *
...
/**
 * @class IInputFacade
 * @brief The IInputFacade interface defines the methods that a concrete input facade must
 * implement.
 *
 * The input facade is responsible for handling all input from the user. This includes keyboard
 * input, mouse input and controller input.
 */
class IInputFacade
{
  public:
    ...
    /**
     * @brief Check if any key is pressed this frame.
     *
     * @return true if any key is down.
     * @return false if no key is down.
     */
     ...
     *
     * @return true if any key is up.
     * @return false if no key is up.
     */
     ...
     *
     * @return Point containing the mouse position.
     */
     ...
     */
    virtual double GetAxis() const = 0;
     ...
     */
    virtual void RegisterAction(const std::string &action) = 0;
     ...
     */
    virtual void UnregisterAction(const std::string &action) = 0;
     ...
     */
    virtual std::vector<KeyCode> GetKeysForAction(const std::string &action) const = 0;
     ...
     */
    virtual std::vector<MouseButton> GetMouseButtonsForAction(const std::string &action) const = 0;
     ...
     */
    virtual void BindKey(KeyCode key, const std::string &action) = 0;
     ...
     */
    virtual void BindMouseButton(MouseButton button, const std::string &action) = 0;
     ...
     */
    virtual void UnbindKey(KeyCode key) = 0;
     ...
     */
    virtual void UnbindMouseButton(MouseButton button) = 0;
     ...
     */
    virtual std::string GetActionForKey(KeyCode key) const = 0;
     ...
     */
    virtual std::string GetActionForMouseButton(MouseButton button) const = 0;
     ...
     */
    virtual bool AnyAction() const = 0;
     ...
     */
    virtual bool AnyActionDown() const = 0;
     ...
     */
    virtual bool AnyActionUp() const = 0;
     ...
     * @return True if any action is being performed, false otherwise.
     */
    virtual bool GetAction(const std::string &action) const = 0;
     ...
     */
    virtual bool GetActionDown(const std::string &action) const = 0;
