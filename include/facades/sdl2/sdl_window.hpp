 ...
 * @brief This file contains the Window class definition for managing an SDL_Window.
 * @version 0.1
 * @date 2023-11-08
 *
 * The Window class provides a simple interface for creating, displaying, and
 ...
 */
class Window {
    SDL_Window* window; ///< Pointer to the SDL_Window managed by this class.
