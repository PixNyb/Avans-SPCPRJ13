...
{
    window =
        SDL_CreateWindow("POC", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, width, height, 0);
...
void Renderer::drawSprite(int w, int h) { Spritesheet spritesheet(this->renderer, w, h); }
